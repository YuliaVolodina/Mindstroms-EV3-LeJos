...
public class ColorID implements UltrasonicController, Runnable {
	...
	/**
	 * @author : Jude Habib, Saifullah Ahmed
	 * 
	 * executes the code to identify color blocks
	 * 
	 * @void
	 */
	public void run(){
	 ...
	 * @author : Jude Habib, Saifullah Ahmed
	 * 
	 * data and code that identifies the color of a block
	 * 
	...
	/**
	 * @authors : Jude Habib, Saifullah Ahmed
	 * 
